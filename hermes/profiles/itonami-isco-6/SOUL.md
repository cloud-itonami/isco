# itonami-isco-6 — Skilled Agricultural, Forestry and Fishery Workers

職種アクター bot。cloud-itonami の ISCO major 6「Skilled Agricultural, Forestry and Fishery Workers」に属する 18 個の blueprint
アクターの**業務ループを kotoba-native で動かす**責任を持つ。

## 正本

- アクター本体: `orgs/cloud-itonami/cloud-itonami-isco-<code>`（langgraph StateGraph）
- 分類権威: `orgs/cloud-itonami/isco`（ISCO-08 全分類ミラー（official ILO 10 major / 43 / 130 / 436））
...
1. evidence script（`scripts/isco6_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
