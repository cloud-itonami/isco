#!/usr/bin/env python3
"""Measurements for the itonami-isco-6 bot (Skilled Agricultural, Forestry and Fishery Workers).
...
lives in isco6_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-6"
COOLDOWN_H = float(os.environ.get("ISCO6_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco6_evidence.cljs")],
