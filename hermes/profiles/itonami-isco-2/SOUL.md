# itonami-isco-2 — Professionals

職種アクター bot。cloud-itonami の ISCO major 2「Professionals」に属する 57 個の blueprint
...
1. evidence script（`scripts/isco2_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
