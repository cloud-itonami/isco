#!/usr/bin/env python3
"""Measurements for the itonami-isco-2 bot (Professionals).
...
lives in isco2_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-2"
COOLDOWN_H = float(os.environ.get("ISCO2_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco2_evidence.cljs")],
