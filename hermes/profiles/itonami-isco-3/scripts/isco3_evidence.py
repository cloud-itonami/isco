#!/usr/bin/env python3
"""Measurements for the itonami-isco-3 bot (Technicians and Associate Professionals).
...
lives in isco3_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-3"
COOLDOWN_H = float(os.environ.get("ISCO3_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco3_evidence.cljs")],
