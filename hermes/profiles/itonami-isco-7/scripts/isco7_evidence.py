#!/usr/bin/env python3
"""Measurements for the itonami-isco-7 bot (Craft and Related Trades Workers).
...
lives in isco7_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-7"
COOLDOWN_H = float(os.environ.get("ISCO7_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco7_evidence.cljs")],
