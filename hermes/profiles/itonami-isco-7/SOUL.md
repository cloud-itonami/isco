# itonami-isco-7 — Craft and Related Trades Workers

職種アクター bot。cloud-itonami の ISCO major 7「Craft and Related Trades Workers」に属する 66 個の blueprint
...
1. evidence script（`scripts/isco7_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
