# itonami-isco-8 — Plant and Machine Operators and Assemblers

職種アクター bot。cloud-itonami の ISCO major 8「Plant and Machine Operators and Assemblers」に属する 40 個の blueprint
...
1. evidence script（`scripts/isco8_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
