#!/usr/bin/env python3
"""Measurements for the itonami-isco-8 bot (Plant and Machine Operators and Assemblers).
...
lives in isco8_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-8"
COOLDOWN_H = float(os.environ.get("ISCO8_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco8_evidence.cljs")],
