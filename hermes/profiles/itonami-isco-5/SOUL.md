# itonami-isco-5 — Services And Sales Workers

職種アクター bot。cloud-itonami の ISCO major 5「Services And Sales Workers」に属する 16 個の blueprint
...
1. evidence script（`scripts/isco5_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
