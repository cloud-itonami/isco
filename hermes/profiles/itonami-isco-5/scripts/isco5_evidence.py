#!/usr/bin/env python3
"""Measurements for the itonami-isco-5 bot (Services And Sales Workers).
...
lives in isco5_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-5"
COOLDOWN_H = float(os.environ.get("ISCO5_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco5_evidence.cljs")],
