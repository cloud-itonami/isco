# itonami-isco-9 — Elementary Occupations

職種アクター bot。cloud-itonami の ISCO major 9「Elementary Occupations」に属する 25 個の blueprint
...
1. evidence script（`scripts/isco9_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
