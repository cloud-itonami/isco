#!/usr/bin/env python3
"""Measurements for the itonami-isco-9 bot (Elementary Occupations).
...
lives in isco9_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-9"
COOLDOWN_H = float(os.environ.get("ISCO9_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco9_evidence.cljs")],
