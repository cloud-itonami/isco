#!/usr/bin/env python3
"""Measurements for the itonami-isco-1 bot (Managers).
...
lives in isco1_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isco-1"
COOLDOWN_H = float(os.environ.get("ISCO1_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isco1_evidence.cljs")],
