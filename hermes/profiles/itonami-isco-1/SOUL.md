# itonami-isco-1 — Managers

職種アクター bot。cloud-itonami の ISCO major 1「Managers」に属する 29 個の blueprint
...
1. evidence script（`scripts/isco1_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
